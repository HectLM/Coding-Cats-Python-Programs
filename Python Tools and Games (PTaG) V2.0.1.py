...
elif start != "Y".lower() or start != "N".lower():
    print("I am going to take that as a 'Yes'")
else:
    print("Welcome")
...
if answer=="G".lower():
    ...
    if WCS=="A".lower():
        ...
        if role=="Kit".lower():
            suffix="kit"
        elif role=="Apprentice".lower():
            suffix="paw"
        elif role=="Warrior".lower():
            warriorSuffix = [
                "tail",
                "leaf",
                "heart",
